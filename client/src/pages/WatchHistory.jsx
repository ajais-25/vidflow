        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center">
            <div
              ...
              aria-hidden="true"
            >
              <div className="absolute inset-0 bg-gray-900 opacity-75 dark:opacity-90"></div>
            </div>

            <div className="relative inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
              <div className="mb-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                  Are you sure you want to clear your watch history? This action
                  cannot be undone.
                </p>
